...
namespace lr 
{
	namespace ui
	{
		public class MissileController : UnityEngine.MonoBehaviour
		{
			...
			public data.MissileInstance MissileInstance { get; private set; }
			...
			public void StartProducing()
			{
				...
				if (CurrentState == State.Inactive)
				{
					...
					TimerEnd = TimerStart + MissileInstance.RefreshTime;
			...
			public void OnClick()
			{
				if (CurrentState == State.Finished)
				{
					Game.Instance.Battle.ReleaseMissile (MissileInstance, obj.Types.Side.Player);
